...
from bank_scraping import get_latest_file
...
# Global variables
# current_month = get_latest_file('United_Data_Files/', 'xlsx')
current_month = prepare_excel_file()
files_list = [
    current_month,
    'Full Months Files/United_Data_06-2024.xlsx',
    'Full Months Files/United_Data_05-2024.xlsx',
    'Full Months Files/United_Data_04-2024.xlsx',
    'Full Months Files/United_Data_03-2024.xlsx',
    'Full Months Files/United_Data_02-2024.xlsx',
    'Full Months Files/United_Data_01-2024.xlsx'
    ]
...
def popup():
    script = '''
    set dialogText to "Choose an option:"
    set button1 to "להריץ טעינה מלאה"
    set button2 to "להריץ מתוך אקסל האחרון"
    set userChoice to button returned of (display dialog dialogText buttons {button1, button2} default button button2 with title "Select an Action" with icon note)
    return userChoice
    '''
    ...
    if choice == "להריץ מתוך אקסל האחרון":
        return "yes"
    elif choice == "להריץ טעינה מלאה":
        return "no"
    else:
        return None
...
# File paths
goals_file_path = '/Users/matveybernshtein/PycharmProjects/Flask Site/Goals.xlsx'
...
if __name__ == '__main__':
    # chocie = popup()
    # if popup() == 'yes':
    #     actuals_file_path = get_latest_file('/Users/matveybernshtein/PycharmProjects/Flask Site/United_Data_Files/')
    # elif popup() == 'no':
    #     actuals_file_path = prepare_excel_file()
    # else:
    #     exit()

    # actuals_file_path = get_latest_file('/Users/matveybernshtein/PycharmProjects/Flask Site/United_Data_Files/', 'xlsx')
    # actuals_file_path = prepare_excel_file()
